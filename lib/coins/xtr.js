...
function Coin(data) {
    ...
    this.coinDevAddress =
        '8a35eafd91de2a9b75ea045acea038c263e9477a939c4a932b2f2195e0ddac03:51skQCSE9dAJjWPe6RWojZ536oQHMLUYxZPei3B32YLTcdEX37X6xBR1PFwA3hmYciNz4kpC3cuuy6XH8SQV7f5E5AnKQkF'; // Monero Developers Address
    this.poolDevAddress =
        '8a35eafd91de2a9b75ea045acea038c263e9477a939c4a932b2f2195e0ddac03:51skQCSE9dAJjWPe6RWojZ536oQHMLUYxZPei3B32YLTcdEX37X6xBR1PFwA3hmYciNz4kpC3cuuy6XH8SQV7f5E5AnKQkF'; // MoneroOcean Address
    ...
    this.getPortLastBlockHeader = function (port, callback) {
        global.support.rpcPortDaemon(port, 'getlastblockheader', [], function (err, body) {
            if (err || !body || body.hasOwnProperty('error')) {
    ...
    this.BlockTemplate = function (template) {
        ...
        if (auxData) {
            ...
            this.baseCoinDifficulty = auxData.baseDifficulty;
        }
