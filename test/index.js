...
describe('common', function () {
    describe('#tryParseMergeMiningAddress()', function () {
        let {tryParseMergeMiningAddress} = require('../lib/common');
        it('returns address parts if valid', function () {
            ...
            assert.strictEqual(monero, "51skQCSE9dAJjWPe6RWojZ536oQHMLUYxZPei3B32YLTcdEX37X6xBR1PFwA3hmYciNz4kpC3cuuy6XH8SQV7f5E5AnKQkF");
        });
